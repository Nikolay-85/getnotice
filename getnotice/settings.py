...
DATABASES = {
    'default': {
        ...
        'NAME': 'gn',                      # Or path to database file if using sqlite3.
        'USER': 'gn',                      # Not used with sqlite3.
        'PASSWORD': 'gn',                  # Not used with sqlite3.
...
SECRET_KEY = 'd(q^kol=^d4*k77rko#%o(=fp0sl_1nad72u)v4!$w!&amp;@g876g'
